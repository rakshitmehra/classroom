...
public class studentViewAssignment extends javax.swing.JFrame {
    ...
    MyTableModel tm;
    String s_email;
    public studentViewAssignment(String email) {
        initComponents();
        al2 = new ArrayList<assignment>();
        jt = new JTable();
        jsp = new JScrollPane(jt);
        jsp.setBounds(60, 154, 651, 257);
        tm = new MyTableModel();
    ...
    private void initComponents() {
        ...
        bt2.setBounds(562, 112, 94, 23);

        bt3.setText("Submit Assignment");
    ...
    private void bt1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt1ActionPerformed
        ...
        while (st.hasMoreTokens()) {
            ...
            al2.add(new assignment(id, t_email, title, detail, datetime, course, semester, lastdate, file));
        }
    ...
    private void bt3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt3ActionPerformed
        // TODO add your handling code here:
        submitAssignment obj = new submitAssignment(s_email);
        obj.setVisible(true);
        dispose();
